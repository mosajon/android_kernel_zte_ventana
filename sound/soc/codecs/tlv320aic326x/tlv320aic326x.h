...
//temporary soulution or test
//#define NO_PROCESS_SWTITCH 
...
//change from 1024 to 128*5 = 640
#define	AIC3262_CACHEREGNUM		640
#define BIT7             (0x01 << 7)
#define BIT6             (0x01 << 6)
#define BIT5             (0x01 << 5)
#define BIT4             (0x01 << 4)
...
#define HEAD_MIC_STATE (0x03<<4)
#define HEAD_HS_STATE (0x03)
#define DAC_FLAG_R2		38

#define STICKY_FLAG1		42
#define INT_FLAG1		43
#define STICKY_FLAG2		44
#define HEADSET_BUTTON_EVENT_BIT (1<<5)
#define HEADSET_DETECT_EVENT_BIT (1<<4)
#define STICKY_FLAG3		45
#define INT_FLAG2		46
#define HEADSET_BUTTON_BIT (1<<5)
#define HEADSET_DETECT_BIT (1<<4)
#define INT1_CNTL		48
#define INT2_CNTL		49
#define INT_FMT			51
...
#define HPLR_VOL_MASK    (0x3F)
#define CHRG_PUMP_CNTL_R1		(PAGE_1 + 33)
#define CHRG_PUMP_CNTL_R2		(PAGE_1 + 34)
#define CHRG_PUMP_CNTL_R3  (PAGE_1 + 35)
#define RAMP_CNTL_R1		(PAGE_1 + 36)
#define RAMP_CNTL_R2		(PAGE_1 + 37)
#define IN1L_SEL_RP		(PAGE_1 + 38)
#define IN1R_SEL_RM		(PAGE_1 + 39)
#define REC_AMP_CNTL_R5		(PAGE_1 + 40)
#define RCV_AP_ENABLE_BIT (0x03<<6)
#define RCV_AMP_VOLUME_BIT (0x3F)
...
#define ANG_GAIN_FLG		(PAGE_1 + 63)
#define OUTMIX_GAIN_FLG		(PAGE_1 + 64)
#define INMIX_GAIN_FLG		(PAGE_1 + 65)
#define DRIV_PWR_FLG		(PAGE_1 + 66)
...
#define ASI3_ADC_CNTRL_REG	(PAGE_4 + 48)
...
#define MINIDSP_ASI_SYNC_REG	(PAGE_4 + 119)
...
#define DOUT3_ENUM          4
#define DIN3_ENUM             5
//ZTE: audio fix gain/volume, begin
#define DACLR_FIX_VOLUME 0x00
//if use modem side AEC algorithm, define AEC_NC_ENABLE as 0
#define AEC_NC_ENABLE  1
#if AEC_NC_ENABLE
//right speaker should has a vloume other than 0,
//otherwise left speaker cannot play stereo music
#define SPKLR_AMP_FIX_VOLUME 0x33
#define HPLR_FIX_VOLUME 0x80
#define RCV_FIX_VOLUME 0x12
#define FM_GAIN_FOR_HP 46
#define FM_GAIN_FOR_SPK 48
#else //use modem AEC
#define SPKLR_AMP_FIX_VOLUME 0x44
#define HPLR_FIX_VOLUME 0x88
#define RCV_FIX_VOLUME 0x15
//this vlaue should be adjusted if hp output gain is modified
#define FM_GAIN_FOR_HP 12
#define FM_GAIN_FOR_SPK 48
#endif
//ZTE: audio fix gain/volume, end
...
struct aic3262_priv {
	...
	void *control_data;
#endif
	struct input_dev	*idev;  //zuoziqiang add for input event report
	int current_config; /*maintains current minidsp patch config*/
	u8 fm_path;
	struct mutex mutex; 	/* protect this private data	 */
	u8 *reg_buffer;		/* Local Register Write Buffer */
};
...
#ifdef CONFIG_OMAP_AIC3262
#define CODEC_GET_DAI_ID(dai)	((dai)->driver->id)
#else
#define CODEC_GET_DAI_ID(dai)	((dai)->id)
#endif
