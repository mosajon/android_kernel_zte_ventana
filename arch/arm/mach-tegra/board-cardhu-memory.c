...
static const struct tegra_emc_table cardhu_emc_tables_samsung[] = 
{
	...
	},
	{
		...
		204000,     /* SDRAM frequency */
		{
			...
			0x00080506, /* MC_EMEM_ARB_DA_COVERS */
	...
	},
	{
		...
		333000,     /* SDRAM frequency */
		{
			...
			0x0000000d, /* EMC_RDV */
			0x000004ed, /* EMC_REFRESH */
			0x00000000, /* EMC_BURST_REFRESH_NUM */
			0x0000013b, /* EMC_PRE_REFRESH_REQ_CNT */
			...
			0x0000002f, /* EMC_TXSR */
			0x0000002f, /* EMC_TXSRDLL */
			0x00000005, /* EMC_TCKE */
			0x00000011, /* EMC_TFAW */
			0x00000007, /* EMC_TRPAB */
			0x00000004, /* EMC_TCLKSTABLE */
			0x00000002, /* EMC_TCLKSTOP */
			0x0000056b, /* EMC_TREFBW */
			0x00000007, /* EMC_QUSE_EXTRA */
			0x00000004, /* EMC_FBIO_CFG6 */
			0x00000000, /* EMC_ODT_WRITE */
			0x00000000, /* EMC_ODT_READ */
			0x00004282, /* EMC_FBIO_CFG5 */
			0x00410084, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			...
			0x00000802, /* EMC_CTT_TERM_CTRL */
			0x00064000, /* EMC_ZCAL_INTERVAL */
			0x00000078, /* EMC_ZCAL_WAIT_CNT */
			0x000b000b, /* EMC_MRS_WAIT_CNT */
			0xa0f10000, /* EMC_AUTO_CAL_CONFIG */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
			0x80000aeb, /* EMC_DYN_SELF_REF_CONTROL */
			0x00000005, /* MC_EMEM_ARB_CFG */
			0x8000003c, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			0x00000001, /* MC_EMEM_ARB_TIMING_RCD */
			0x00000002, /* MC_EMEM_ARB_TIMING_RP */
		...
		0x0000001e, /* EMC_ZCAL_WAIT_CNT after clock change */
		0x001fffff, /* EMC_AUTO_CAL_INTERVAL */
		0x00000001, /* EMC_CFG.PERIODIC_QRST */
		0x00000000, /* Mode Register 0 */
...
{
	{
		...
		0x00000008, /* EMC_ZCAL_WAIT_CNT after clock change */
		0x001fffff, /* EMC_AUTO_CAL_INTERVAL */
		0x00000001, /* EMC_CFG.PERIODIC_QRST */
		0x00000000, /* Mode Register 0 */
		0x00010022, /* Mode Register 1 */
	...
	},
	{
		...
		204000,     /* SDRAM frequency */
		{
			...
			0x004400a4, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x000c0000, /* EMC_DLL_XFORM_DQS0 */
			0x000c0000, /* EMC_DLL_XFORM_DQS1 */
			0x000c0000, /* EMC_DLL_XFORM_DQS2 */
			0x000c0000, /* EMC_DLL_XFORM_DQS3 */
			0x000c0000, /* EMC_DLL_XFORM_DQS4 */
			0x000c0000, /* EMC_DLL_XFORM_DQS5 */
			0x000c0000, /* EMC_DLL_XFORM_DQS6 */
			0x000c0000, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x000bc000, /* EMC_DLL_XFORM_DQ0 */
			0x000bc000, /* EMC_DLL_XFORM_DQ1 */
			0x000bc000, /* EMC_DLL_XFORM_DQ2 */
			0x000bc000, /* EMC_DLL_XFORM_DQ3 */
			0x00120220, /* EMC_XM2CMDPADCTRL */
			0x0400201c, /* EMC_XM2DQSPADCTRL2 */
			0x00000000, /* EMC_XM2DQPADCTRL2 */
			0x77ffc004, /* EMC_XM2CLKPADCTRL */
			0x01f1f008, /* EMC_XM2COMPPADCTRL */
			0x00000000, /* EMC_XM2VTTGENPADCTRL */
	...
	},
	{
		...
		333000,     /* SDRAM frequency */
		{
			...
			0x0000000c, /* EMC_RDV */
			0x000004eb, /* EMC_REFRESH */
			0x00000000, /* EMC_BURST_REFRESH_NUM */
			0x0000013a, /* EMC_PRE_REFRESH_REQ_CNT */
			0x00000002, /* EMC_PDEX2WR */
			0x00000002, /* EMC_PDEX2RD */
			0x00000005, /* EMC_PCHG2PDEN */
			0x00000000, /* EMC_ACT2PDEN */
			...
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
			0x80000ae8, /* EMC_DYN_SELF_REF_CONTROL */
			0x00000005, /* MC_EMEM_ARB_CFG */
			0x8000003c, /* MC_EMEM_ARB_OUTSTANDING_REQ */
			0x00000001, /* MC_EMEM_ARB_TIMING_RCD */
			0x00000002, /* MC_EMEM_ARB_TIMING_RP */
...
static const struct tegra_emc_chip cardhu_emc_chips[] = {
	{
		.description = "Samsung 333MHz",
...
int cardhu_emc_init(void)
{
	...
	if( cardhu_emc_chips[0].mem_manufacturer_id == maker_id)
	{
	    tegra_init_emc(cardhu_emc_tables_samsung, ARRAY_SIZE(cardhu_emc_tables_samsung));
	}	
       else if( cardhu_emc_chips[1].mem_manufacturer_id == maker_id )
       {
