...
#include <mach/kbc.h>
#include <asm/io.h>  /*ZTE: added by tong.weili 解决待机按下power键偶发无法点亮屏幕20111206*/
#include "board.h"
#include "board-cardhu.h"

#include "gpio-names.h"
#include "wakeups-t3.h" /*ZTE: added by tong.weili 解决待机按下power键偶发无法点亮屏幕20111206*/
...
static struct gpio_keys_button cardhu_keys_e1291[] = {
    ...
    [1] = GPIO_KEY(KEY_VOLUMEUP, PI1, 0),
    [2] = GPIO_KEY(KEY_VOLUMEDOWN, PI2, 0),
};

/*ZTE: added by tong.weili 解决待机按下power键偶发无法点亮屏幕20111206 ++*/
#define PMC_WAKE_STATUS		0x14
static int cardhu_wakeup_key(void)
{
    unsigned long status =
    readl(IO_ADDRESS(TEGRA_PMC_BASE) + PMC_WAKE_STATUS);
    printk("[tong]**********************wakeup key\n");
    
    return status & TEGRA_WAKE_GPIO_PV0 ? KEY_POWER : KEY_RESERVED;
}
/*ZTE: added by tong.weili 解决待机按下power键偶发无法点亮屏幕20111206 --*/
...
static struct gpio_keys_platform_data cardhu_keys_e1291_platform_data = {
	...
	.wakeup_key     = cardhu_wakeup_key,    /*ZTE: added by tong.weili 解决待机按下power键偶发无法点亮屏幕20111206*/
};
