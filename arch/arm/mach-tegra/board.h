...
enum audio_codec_type {
	audio_codec_none,
	audio_codec_max98095,
};

typedef enum 
{
    ZTE_FLAG_CHARGE_POWERON, // power on with charger
    ZTE_FLAG_CHARGE_TYPE,  // 1, AC charger, else USB charger
    ZTE_FLAG_RTC_POWERON,   // power on with rtc
    ZTE_FLAG_FACTORY_MODE,  // 1, power on  in factory mode; else, normal mode
    /* please add your tags below */
...
extern unsigned int g_zte_poweron_mode;
