...
static __initdata struct tegra_pingroup_config cardhu_pinmux_common[] = {
	...
	DEFAULT_PINMUX(GPIO_PV3,        RSVD1,           NORMAL,    TRISTATE,   INPUT),
	...
	DEFAULT_PINMUX(KB_ROW5,         OWR,             NORMAL,    NORMAL,     OUTPUT),
      ...
      /*ZTE: deleted by tong.weili for stack warning 20111229 ++*/
	//DEFAULT_PINMUX(KB_ROW12,        MIO,             NORMAL,    NORMAL,     OUTPUT),  /*ZTE:modify by jiabf for CMMB 20110818 */
	//DEFAULT_PINMUX(KB_ROW14,        MIO,             NORMAL,    NORMAL,     OUTPUT),  /*ZTE:modify by jiabf for CMMB 20110818 */
	//DEFAULT_PINMUX(KB_ROW15,        MIO,             NORMAL,    NORMAL,     OUTPUT),  /*ZTE:modify by jiabf for CMMB 20110818 */
	/*ZTE: deleted by tong.weili for stack warning 20111229 --*/
	...
	DEFAULT_PINMUX(CAM_MCLK,        VI_ALT2,         PULL_UP,   NORMAL,     OUTPUT),
	DEFAULT_PINMUX(GPIO_PCC1,       RSVD1,           PULL_DOWN,    NORMAL,     OUTPUT),
	DEFAULT_PINMUX(GPIO_PBB0,       RSVD1,           NORMAL,    NORMAL,     OUTPUT),

        
	DEFAULT_PINMUX(GPIO_PBB3,       VGP3,            PULL_DOWN,    NORMAL,     OUTPUT),
	DEFAULT_PINMUX(GPIO_PBB5,       VGP5,            PULL_UP,    NORMAL,     OUTPUT),
	DEFAULT_PINMUX(GPIO_PBB6,       VGP6,            PULL_UP,    NORMAL,     OUTPUT),
	...
	DEFAULT_PINMUX(SPI1_MOSI,       SPI1,            NORMAL,    TRISTATE,     INPUT),/*ZTE:modify by wangtao for CMMB 20110902 */
	DEFAULT_PINMUX(SPI1_SCK,        SPI1,            NORMAL,    TRISTATE,     INPUT),/*ZTE:modify by wangtao for CMMB 20110902 */
	DEFAULT_PINMUX(SPI1_CS0_N,      SPI1,            NORMAL,    TRISTATE,     INPUT),/*ZTE:modify by wangtao for CMMB 20110902 */
	DEFAULT_PINMUX(SPI1_MISO,       SPI1,            NORMAL,    TRISTATE,     INPUT),/*ZTE:modify by wangtao for CMMB 20110902 */
	...
	DEFAULT_PINMUX(SPI2_SCK,        GMI,             NORMAL,    NORMAL,     INPUT),
        DEFAULT_PINMUX(GPIO_PBB4,       VGP4,            PULL_UP,    NORMAL,     OUTPUT),
	...
	DEFAULT_PINMUX(KB_ROW10,         KBC,             PULL_UP,   NORMAL,     INPUT),    /*zte lipeng10094834 add at 2011.07.18*/        
};
...
static __initdata struct tegra_pingroup_config cardhu_pinmux_cardhu[] = {
	...
	/* Power rails GPIO */
	//DEFAULT_PINMUX(GMI_CS2_N,       NAND,            NORMAL,    NORMAL,     OUTPUT),//ZTE:del by caixiaoguang 20110902
	DEFAULT_PINMUX(GMI_RST_N,       RSVD3,           PULL_UP,   TRISTATE,   INPUT),
	DEFAULT_PINMUX(GMI_AD15,        NAND,            PULL_UP,   TRISTATE,   INPUT),
...
static __initdata struct tegra_pingroup_config unused_pins_lowpower[] = {
	...
	DEFAULT_PINMUX(GMI_CS3_N,       NAND,           NORMAL,     NORMAL,       OUTPUT),
	DEFAULT_PINMUX(GMI_CS6_N,       SATA,           NORMAL,     TRISTATE,     INPUT),//revised by zhanming 20111121
	...
	DEFAULT_PINMUX(GMI_OE_N,        NAND,           PULL_UP,     NORMAL,     INPUT),
	DEFAULT_PINMUX(GMI_DQS,         NAND,           PULL_UP,     NORMAL,     INPUT),
};
...
static void __init cardhu_pinmux_audio_init(void)
{
	...
	gpio_request(TEGRA_GPIO_CDC_IRQ, "max98095");
...
#if 0 // ZTE: deleted by pengtao for version control --
	tegra_get_board_info(&board_info);
	switch (board_info.board_id) {
	case BOARD_E1198:
...
struct gpio_init_pin_info pin_lpm_cardhu_common[] = {
	...
	/* ZTE zzq  remove 20110722 for charger*/
