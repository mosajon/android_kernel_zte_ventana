...
/*nvidia danny modify 2011.07.29*/
	//REGULATOR_SUPPLY("p_cam_avdd", NULL),
        REGULATOR_SUPPLY("iovcc_lcd", NULL),
/*nvidia danny modify end 2011.07.29*/
};
...
/*ZTE:added by lupoyuan10105246 for sd power  20110804 ++*/
...
#define REGULATOR_INIT_ON(_id, _minmv, _maxmv, _boot_on, _always_on, config)			\
	{								\
		.constraints = {					\
			.min_uV = (_minmv)*1000,			\
			.max_uV = (_maxmv)*1000,			\
...
static struct regulator_init_data ldo0_data = REGULATOR_INIT(ldo0, 1250, 3300, OFF/*OFF,nvidia danny modify  2011.07.29*/, NULL);
static struct regulator_init_data ldo1_data = REGULATOR_INIT(ldo1, 725, 1500, ON, NULL);
static struct regulator_init_data ldo2_data = REGULATOR_INIT(ldo2, 725, 1500, OFF/*OFF,nvidia danny modify  2011.07.29*/, NULL);
static struct regulator_init_data ldo3_data = REGULATOR_INIT_ON(ldo3, 3300, 3300, ON, OFF, NULL);
static struct regulator_init_data ldo4_data = REGULATOR_INIT(ldo4, 1700, 2475, ON/*OFF,nvidia danny modify  2011.07.29*/, NULL);
static struct regulator_init_data ldo5_data = REGULATOR_INIT(ldo5, 1250, 3300, ON, NULL);
static struct regulator_init_data ldo6_data = REGULATOR_INIT(ldo6, 1250, 1800, OFF/*OFF,nvidia danny modify  2011.07.29*/, NULL);
static struct regulator_init_data ldo7_data = REGULATOR_INIT(ldo7, 3300, 3300, OFF/*OFF,nvidia danny modify  2011.07.29*/, NULL);
static struct regulator_init_data ldo8_data = REGULATOR_INIT(ldo8, 3300, 3300, OFF/*OFF,nvidia danny modify  2011.07.29*/, NULL);
static struct regulator_init_data ldo9_data = REGULATOR_INIT(ldo9, 1250, 3300, OFF/*OFF,nvidia danny modify  2011.07.29*/, NULL);

static struct tps6586x_rtc_platform_data rtc_data = {
//irq = TEGRA_NR_IRQS + TPS6586X_INT_RTC_ALM1,
	.irq = TEGRA_NR_IRQS + TPS6586X_INT_RTC_ALM2,
	.start = {
		.year = 2012,
		.month = 2,
		.day = 20,
