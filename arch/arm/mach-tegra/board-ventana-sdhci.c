...
#define VENTANA_WLAN_RST	TEGRA_GPIO_PU2
#define VENTANA_WLAN_WOW	TEGRA_GPIO_PU6
...
static struct resource wifi_resource[] = {
	[0] = {
		...
		.start = TEGRA_GPIO_TO_IRQ(VENTANA_WLAN_WOW),
		.end   = TEGRA_GPIO_TO_IRQ(VENTANA_WLAN_WOW),
