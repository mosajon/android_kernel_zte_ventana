...
TPS_PDATA_INIT(ldo2, 0,         1000, 3300, tps6591x_rails(VDD_2), 0, 0, 0, 3300, 1, 1, 0, 0);

TPS_PDATA_INIT(ldo3, e1198,     1000, 3300, 0, 0, 0, 0, 1800, 0, 0, 0, 0);
TPS_PDATA_INIT(ldo4, 0,         1000, 3300, 0, 1, 0, 0, 1200, 0, 0, 0, 0);
TPS_PDATA_INIT(ldo5, e1198,     1000, 3300, 0, 0, 0, 0, 3000, 0, 0, 0, 0);
...
TPS_PDATA_INIT(ldo8, 0,         1000, 3300, tps6591x_rails(VIO), 1, 0, 0, 1000, 0, 0, 0, LDO_LOW_POWER_ON_SUSPEND);
...
#if 0   //close for remove warning by zhanming 20120117
...
int __init cardhu_regulator_init(void)
{
	...
	//regulator_has_full_constraints(); // dongjinguang on 20111206
...
GREG_INIT(1, en_5v0,		en_5v0,		NULL,			0,      0,      TPS6591X_GPIO_2,	false,	1,	0,	0,	0);
GREG_INIT(2, en_3v3_sys,	en_3v3_sys,	NULL,			1,      0,      TPS6591X_GPIO_6,	false,	1,	0,	0,	0);
GREG_INIT(3, en_3v3_modem,	en_3v3_modem,	NULL,			1,      0,      TEGRA_GPIO_PD6,		false,	1,	0,	0,	0);
GREG_INIT(4, cam3_ldo_en,	cam3_ldo_en,	"vdd_3v3_devices",	0,      0,      TEGRA_GPIO_PS0,		false,	0,	0,	0,	0);
GREG_INIT(5, en_vdd_com,	en_vdd_com,	"vdd_3v3_devices",	1,      0,      TEGRA_GPIO_PD0,		false,	1,	0,	0,	0);
GREG_INIT(6, en_3v3_fuse,	en_3v3_fuse,	"vdd_3v3_devices",	0,      0,      TEGRA_GPIO_PL6,		false,	0,	0,	0,	0);
GREG_INIT(7, en_3v3_emmc,	en_3v3_emmc,	"vdd_3v3_devices",	1,      0,      TEGRA_GPIO_PD1,		false,	1,	0,	0,	0);
GREG_INIT(8, en_3v3_pex_hvdd,	en_3v3_pex_hvdd, "hvdd_pex_pmu",	0,      0,      TEGRA_GPIO_PL7,		false,	0,	0,	0,	0);
//GREG_INIT(9, en_1v8_cam,	en_1v8_cam,	"vdd_gen1v8",		0,      0,      TEGRA_GPIO_INVALID,	false,	0,	0,	0,	0);

/* E1198/E1291 specific  fab < A03 */
GREG_INIT(10, en_usb1_vbus_oc,		en_usb1_vbus_oc,	"vdd_5v0_sys",
		0,      0,      TEGRA_GPIO_INVALID,		false,	0,	TEGRA_PINGROUP_GMI_RST_N,
		enable_load_switch_rail, disable_load_switch_rail);
GREG_INIT(11, en_usb3_vbus_oc,		en_usb3_vbus_oc,	"vdd_5v0_sys",
		0,      0,      TEGRA_GPIO_PH7,		false,	0,	TEGRA_PINGROUP_GMI_AD15,
		enable_load_switch_rail, disable_load_switch_rail);

/* E1198/E1291 specific */
GREG_INIT(12, en_vddio_vid_oc,		en_vddio_vid_oc,	"vdd_5v0_sys",
		0,      0,      TEGRA_GPIO_PT0,		false,	0,	TEGRA_PINGROUP_VI_PCLK,
		enable_load_switch_rail, disable_load_switch_rail);

/* E1198/E1291 specific*/
GREG_INIT(13, cam1_ldo_en,	cam1_ldo_en,	"vdd_3v3_cam",	0,      0,      TEGRA_GPIO_PR6,		false,	0,	0,	0,	0);
GREG_INIT(14, cam2_ldo_en,	cam2_ldo_en,	"vdd_3v3_cam",	0,      0,      TEGRA_GPIO_PR7,		false,	0,	0,	0,	0);
...
static void cardhu_power_off(void)
{
    ...
    ret = tps6591x_pre_power_off();
	if (ret)
		pr_err("cardhu: failed to pre power off\n");
...
int __init cardhu_edp_init(void)
{
	...
	if (!regulator_mA) {
		regulator_mA = 4500; /* regular T30/s */
	}
