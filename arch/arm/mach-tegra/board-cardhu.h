...
#else
#define OV5650_RESETN_GPIO			TEGRA_GPIO_PBB0
#define CAM1_POWER_DWN_GPIO			TEGRA_GPIO_PCC1
//#define CAM2_POWER_DWN_GPIO			TEGRA_GPIO_PCC3
#define CAM3_POWER_DWN_GPIO			TEGRA_GPIO_PBB3
//#define CAMERA_CSI_MUX_SEL_GPIO		TEGRA_GPIO_PCC1
#define CAM1_LDO_EN_GPIO			TEGRA_GPIO_PBB6
//#define CAM2_LDO_EN_GPIO			TEGRA_GPIO_PBB5
#define CAM3_LDO_EN_GPIO			TEGRA_GPIO_PBB5

#define CAMERA_FLASH_MAX_TORCH_AMP	7
#define CAMERA_FLASH_MAX_FLASH_AMP	7

#define CAM_FRONT_1v8_EN_GPIO		TEGRA_GPIO_PBB4
#define CAM_1v8_EN_GPIO			    TEGRA_GPIO_PBB7
#endif
...
#define HDMI_DCDC_ENB	     TEGRA_GPIO_PB2

/*ZTE:added  by wangyunan  for P903N++*/
#define CODEC_CEN_GPIO    TEGRA_GPIO_PK5

/* ZTE: to make up for charger by zhanming 20111024 ++*/
#define CHARGER_DCOK_GPIO     TEGRA_GPIO_PK3
#define CHARGER_STAT_GPIO     TEGRA_GPIO_PJ2
#define CHARGER_FAULT_GPIO    TEGRA_GPIO_PJ0
#define DC_PRESENT_INT		    TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PK3)
#define CHARGER_CEN_GPIO      TEGRA_GPIO_PI7
#define CHARGER_USUS_GPIO     TEGRA_GPIO_PI4
#define CHARGER_DCM_GPIO       TEGRA_GPIO_PU5  
#define DOCK_DET_GPIO          TEGRA_GPIO_PU4
/* ZTE: to make up for charger by zhanming 20111024 --*/

/*ZTE:added by zhanming 20111024 for HDMI ++*/
#define HDMI_DCDC_ENB	     TEGRA_GPIO_PB2

/*ZTE: to make up modem control gpio by caixiaoguang 20110719 ++*/
#define MODEM_POWER_ENB	 TEGRA_GPIO_PY3
#define MODEM_USB3V3_ENB	 TEGRA_GPIO_PH5
#define MODEM_USB_CTRL  	 TEGRA_GPIO_PV1
#define MODEM_DEAD_STAT    TEGRA_GPIO_PH6
#define MODEM_TO_AP_SLP    TEGRA_GPIO_PH4
#define MODEM_TO_AP_WKUP   TEGRA_GPIO_PI6
#define AP_TO_MODEM_SLP    TEGRA_GPIO_PH2
#define AP_TO_MODEM_WKUP   TEGRA_GPIO_PK2
#define MODEM_RST_SET      TEGRA_GPIO_PV3
/*ZTE: to make up modem control gpio by caixiaoguang 20110719 --*/
