...
#define OV5640_IOCTL_SET_BRIGHTNESS       _IOW('o', 9, __u8)
#define OV5640_IOCTL_SET_ISO       _IOW('o', 10, __u8)
#define OV5640_IOCTL_SET_Contrast        _IOW('o', 11, __u8)
#define OV5640_IOCTL_SET_Saturation        _IOW('o', 12, __u8)
#define OV5640_IOCTL_SET_Sharpness        _IOW('o', 13, __u8)
...
enum {
      OV5640_YUV_ColorEffect = 0,
      OV5640_YUV_Whitebalance,
      OV5640_YUV_SceneMode,
      OV5640_YUV_Exposure,
      OV5640_YUV_Brightness,
      OV5640_YUV_ISO,
      OV5640_YUV_Contrast,
      OV5640_YUV_Saturation,
      OV5640_YUV_Sharpness
};

enum {
      OV5640_YUV_ColorEffect_Invalid = 0,
      OV5640_YUV_ColorEffect_Aqua,
      OV5640_YUV_ColorEffect_Blackboard,
      OV5640_YUV_ColorEffect_Mono,
      OV5640_YUV_ColorEffect_Negative,
      OV5640_YUV_ColorEffect_None,
      OV5640_YUV_ColorEffect_Posterize,
      OV5640_YUV_ColorEffect_Sepia,
      OV5640_YUV_ColorEffect_Solarize,
      OV5640_YUV_ColorEffect_Whiteboard,
      OV5640_YUV_ColorEffect_vivid,
      OV5640_YUV_ColorEffect_Emboss,
      OV5640_YUV_ColorEffect_redtint,
      OV5640_YUV_ColorEffect_bluetint,
      OV5640_YUV_ColorEffect_greentint
};

enum {
      OV5640_YUV_Whitebalance_Invalid = 0,
      OV5640_YUV_Whitebalance_Auto,
      OV5640_YUV_Whitebalance_Incandescent,
      OV5640_YUV_Whitebalance_Fluorescent,
      OV5640_YUV_Whitebalance_WarmFluorescent,
      OV5640_YUV_Whitebalance_Daylight,
      OV5640_YUV_Whitebalance_CloudyDaylight,
      OV5640_YUV_Whitebalance_Shade,
      OV5640_YUV_Whitebalance_Twilight,
      OV5640_YUV_Whitebalance_Custom
};

enum {
      OV5640_YUV_SceneMode_Invalid = 0,
      OV5640_YUV_SceneMode_Auto,
      OV5640_YUV_SceneMode_Action,
      OV5640_YUV_SceneMode_Portrait,
      OV5640_YUV_SceneMode_Landscape,
      OV5640_YUV_SceneMode_Beach,
      OV5640_YUV_SceneMode_Candlelight,
      OV5640_YUV_SceneMode_Fireworks,
      OV5640_YUV_SceneMode_Night,
      OV5640_YUV_SceneMode_NightPortrait,
      OV5640_YUV_SceneMode_Party,
      OV5640_YUV_SceneMode_Snow,
      OV5640_YUV_SceneMode_Sports,
      OV5640_YUV_SceneMode_SteadyPhoto,
      OV5640_YUV_SceneMode_Sunset,
      OV5640_YUV_SceneMode_Theatre,
      OV5640_YUV_SceneMode_Barcode,
      OV5640_YUV_SceneMode_Backlight,
...
enum {
      OV5640_YUV_Exposure_Negative_2 = -2,
      OV5640_YUV_Exposure_Negative_1,
      OV5640_YUV_Exposure_0,
      OV5640_YUV_Exposure_1,
      OV5640_YUV_Exposure_2
};

enum {
      OV5640_YUV_Brightness_0,
      OV5640_YUV_Brightness_1,
      OV5640_YUV_Brightness_2,
      OV5640_YUV_Brightness_3,
      OV5640_YUV_Brightness_4
};
...
enum {
      ...
      OV5640_YUV_ISO_100,
      OV5640_YUV_ISO_200,
      OV5640_YUV_ISO_400 = 4,
      OV5640_YUV_ISO_800 = 8,
      OV5640_YUV_ISO_1600 = 16
};

enum {
      OV5640_YUV_Contrast_0,
      OV5640_YUV_Contrast_1,
      OV5640_YUV_Contrast_2,
      OV5640_YUV_Contrast_3,
      OV5640_YUV_Contrast_4
};

enum {
      OV5640_YUV_Saturation_0,
      OV5640_YUV_Saturation_1,
      OV5640_YUV_Saturation_2,
      OV5640_YUV_Saturation_3,
      OV5640_YUV_Saturation_4
};

enum {
      OV5640_YUV_Sharpness_0,
      OV5640_YUV_Sharpness_1,
      OV5640_YUV_Sharpness_2,
      OV5640_YUV_Sharpness_3,
      OV5640_YUV_Sharpness_4
};
struct ov5640_mode {
	int xres;
	int yres;
...
enum ov5640_exposure_mode{
        ...
        OV5640_Exposure_1,
        OV5640_Exposure_2,
        OV5640_Exposure_Negative_1=-1,
        OV5640_Exposure_Negative_2 = -2
...
enum ov5640_Brightness_mode{
        OV5640_Brightness_Level1= 0,
        OV5640_Brightness_Level2,
        OV5640_Brightness_Level3,
        OV5640_Brightness_Level4,
        OV5640_Brightness_Level5
};
enum ov5640_Contrast_mode{
        OV5640_Contrast_Level1,
        OV5640_Contrast_Level2,
        OV5640_Contrast_Level3,
        OV5640_Contrast_Level4,
        OV5640_Contrast_Level5
};
enum ov5640_Saturation_mode{
        OV5640_Saturation_Level1,
        OV5640_Saturation_Level2,
        OV5640_Saturation_Level3,
        OV5640_Saturation_Level4,
        OV5640_Saturation_Level5
};
  /* ZTE: add by yaoling for sharpness iso  20111010 ++ */
