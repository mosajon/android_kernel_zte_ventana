 ...
 * see datasheet.
 */
/*zte lipeng10094834 modify at 2011.07.11*/
#define MXT_I2C_ADDRESS                                 MXT224_I2C_ADDR1
/*zte lipeng10094834 modify end */
...
/*zte lipeng10094834 modify at 2011.07.11*/
/*added by wangweiping test for ts begin*/
...
/*added by wangweiping test for ts end*/
/*zte lipeng10094834 modify end*/
...
struct mxt_platform_data {
	u8    numtouch;	/* Number of touches to report	*/
	int  (*init_platform_hw)(void);  //modified by wangweiping for test ts	void  (*init_platform_hw)(void);
	int  (*exit_platform_hw)(void);  //modified by wangweiping for test ts	void  (*exit_platform_hw)(void);
	int   max_x;    /* The default reported X range   */  
	int   max_y;    /* The default reported Y range   */
	u8    (*valid_interrupt) (void);
	int    (*read_chg) (void); //v11 wangwp0002: modified by wangweiping 2011/03/02 for modify the method of read touchscreen message
};
/*zte lipeng10094834 modify end*/
