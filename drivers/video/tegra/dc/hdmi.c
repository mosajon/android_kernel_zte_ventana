...
static unsigned long old_base_clk_rate;
#endif
...
static void tegra_dc_hdmi_disable(struct tegra_dc *dc)
{
	struct tegra_dc_hdmi_data *hdmi = tegra_dc_get_outdata(dc);
#ifdef CONFIG_MACH_VENTANA
    /*zte lipeng10094834 add for restore pll_d*/
        struct clk *base_clk = clk_get_sys(NULL, "pll_d");
        old_base_clk_rate = 461000000;
    	clk_set_rate(base_clk, old_base_clk_rate);
#endif
	tegra_nvhdcp_set_plug(hdmi->nvhdcp, 0);
